...
Shader "QQA/Shader_Portal_Aura"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float localApplyAuraLighting16_g12 = ( 0.0 );
			float3 temp_output_13_0_g12 = _Vector0;
			float3 Color16_g12 = (temp_output_13_0_g12).xyz;
			float4 ase_screenPos = float4( i.screenPos.xyz , i.screenPos.w + 0.00000000001 );
			float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( ase_screenPos );
			float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
			float Depth1_g13 = i.eyeDepth;
			float localRescaleDepth1_g13 = RescaleDepth( Depth1_g13 );
			float3 appendResult2_g13 = (float3(ase_grabScreenPosNorm.r , ase_grabScreenPosNorm.g , localRescaleDepth1_g13));
			float3 temp_output_25_0_g12 = appendResult2_g13;
			float3 BufferCoordinates16_g12 = temp_output_25_0_g12;
			float LightingFactor16_g12 = _Float0;
			float3 LightingValue16_g12 = tex3D( Aura_VolumetricDataTexture, temp_output_25_0_g12 ).rgb;
			Aura2_ApplyLighting(Color16_g12, BufferCoordinates16_g12, LightingFactor16_g12, LightingValue16_g12);
			float4 appendResult23_g12 = (float4(Color16_g12 , (temp_output_13_0_g12).x));
			float4 Color13_g10 = appendResult23_g12;
			float Depth1_g11 = i.eyeDepth;
			...
			c.rgb = Color13_g10.xyz;
			c.a = saturate( round( ( tex2D( _TextureSample0, uv_TextureSample0 ).r + 0.5 ) ) );
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float2 appendResult23_g3 = (float2(( length( CenteredUV15_g3 ) * _Polar_Radial_Length.x * 2.0 ) , ( atan2( break17_g3.x , break17_g3.y ) * ( 1.0 / 6.28318548202515 ) * _Polar_Radial_Length.y )));
			float2 panner6 = ( 1.0 * _Time.y * _Polar_Panner_Speed_X_Y + appendResult23_g3);
...
/*ASEBEGIN
Version=18600
1920;0;1920;1059;906.6761;331.8708;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-2276.35,-1048.83;Inherit;False;Property;_Twirl_Strength;Twirl_Strength;11;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;20;-2197.225,495.743;Inherit;False;Property;_Polar_Panner_Speed_X_Y;Polar_Panner_Speed_X_Y;5;0;Create;True;0;0;False;0;False;1,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;30;-2122.22,-919.7256;Inherit;False;Property;_Twirl_Panner_Speed_X_Y;Twirl_Panner_Speed_X_Y;12;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;18;-2245.876,271.0414;Inherit;True;Polar Coordinates;-1;;3;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1851.559,-896.8611;Inherit;False;Property;_Twirl_Noise_Scale;Twirl_Noise_Scale;13;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-1916.57,435.9481;Inherit;False;Property;_Polar_Noise_Scale;Polar_Noise_Scale;6;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-1703.113,434.1004;Inherit;False;Property;_Polar_Noise_Power;Polar_Noise_Power;7;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-1650.993,-897.0493;Inherit;False;Property;_Twirl_Noise_Power;Twirl_Noise_Power;14;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;49;-1946.795,-102.9989;Inherit;True;Property;_TextureSample0;Texture Sample 0;20;0;Create;True;0;0;False;0;False;-1;2ab42dd1be19f16448bd1feab4b61388;2ab42dd1be19f16448bd1feab4b61388;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;50;-1592.264,-88.27774;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-1654.49,6.958363;Inherit;False;Property;_Overlap_Sub;Overlap_Sub;22;0;Create;True;0;0;False;0;False;0.5;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;21;-1538.301,305.4357;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1485.561,433.6148;Inherit;False;Property;_Polar_Noise_Multiplier;Polar_Noise_Multiplier;8;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;94;-552.8918,-677.8401;Inherit;False;Property;_Overlap_Add;Overlap_Add;23;0;Create;True;0;0;False;0;False;0.5;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;84;-974.0517,821.1532;Inherit;True;Property;_TextureSample2;Texture Sample 2;20;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;49;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;47;-1155.929,-1016.221;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-647.4006,527.095;Inherit;False;Property;_Overlap_Power;Overlap_Power;26;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;108;-175.6761,240.1292;Inherit;False;Property;_Vector0;Vector 0;24;0;Create;True;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;41;-812.5769,-122.7079;Inherit;False;Property;_Emission_Color;Emission_Color;10;1;[HDR];Create;True;0;0;False;0;False;2,0.6588235,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;97;-143.4848,-772.4849;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-115.6761,448.1292;Inherit;False;Property;_Float0;Float 0;25;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;89;-814.9952,87.43272;Inherit;False;Property;_Emission_Ring_Color;Emission_Ring_Color;9;1;[HDR];Create;True;0;0;False;0;False;2,0.2886244,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;107;23.9013,227.6214;Inherit;False;Apply Aura Illumination;3;;12;689e7cb88e5f45447bdfd7327e649316;0;2;13;FLOAT3;0,0,0;False;22;FLOAT;1;False;1;FLOAT4;17
...
Node;AmplifyShaderEditor.Vector2Node;70;-2127.24,-438.39;Inherit;False;Property;_Twirl2_Panner_Speed_X_Y;Twirl2_Panner_Speed_X_Y;19;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-2281.369,-567.4949;Inherit;False;Property;_Twirl2_Strength;Twirl2_Strength;16;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-1656.012,-415.714;Inherit;False;Property;_Twirl2_Noise_Power;Twirl2_Noise_Power;18;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;71;-2083.857,-610.0839;Inherit;False;Twirl;-1;;4;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-1856.578,-415.525;Inherit;True;Property;_Twirl2_Noise_Scale;Twirl2_Noise_Scale;17;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-1449.587,-414.547;Inherit;False;Property;_Twirl2_Noise_Multiplier;Twirl2_Noise_Multiplier;21;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;100;975.4731,-202.9149;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;106;407.0995,227.994;Inherit;False;Apply Aura Fog;1;;10;fb1436f7d9c811346a67189ce659e93e;0;1;3;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.PowerNode;77;-1462.313,-538.183;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;756.5581,27.02685;Float;False;True;-1;4;ASEMaterialInspector;0;0;CustomLighting;QQA/Shader_Portal_Aura;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A79CB7B5F99BAB6D730FB1CC91F5838958D6DDF5